...
class Data extends CI_Controller {
    ...
    public function datatable() {
        $data = $this->data_alumni->get_datatable();
    ...
    public function data() {
        $data = $this->data_alumni->get_datatables();
    ...
    public function view() {
        ...
        $data = $this->data_alumni->get_data_form($post[$this->primaryKey]);
    ...
    public function save() {
        ...
        $result = $this->data_alumni->save($data);
